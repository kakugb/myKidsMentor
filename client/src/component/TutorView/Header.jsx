    ...
    <div className="bg-white shadow-sm shadow-slate-400">
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12">
          <Link to="/tutor/dashboard" className="text-sm font-semibold text-white bg-red-800 p-3 rounded-md hover:bg-red-700">
            Tutor Profile
          </Link>
          <Link to="/tutor/documents" className="text-sm font-semibold text-white bg-red-800 p-3 rounded-md hover:bg-red-700">
            Add Documents
          </Link>
          <Link to="/tutor/messages" className="text-sm font-semibold text-white bg-red-800 p-3 rounded-md hover:bg-red-700">
            Messages
          </Link>
          <Link to="/tutor/reviews" className="text-sm font-semibold text-white bg-red-800 p-3 rounded-md hover:bg-red-700">
            Reviews & Rating
          </Link>
