            ...
            <div class="grid grid-cols-2 min-[690px]:grid-cols-4 lg:grid-cols-6 gap-4 xl:gap-8 pt-14 pb-10 max-w-xs mx-auto min-[690px]:max-w-2xl lg:max-w-full">
                ...
                {/* <div class="lg:mx-auto text-left ">
                    ...
                    <ul class="text-sm  transition-all duration-500">
                        ...
                        <li class="mb-6"><Link to=''  class=" text-gray-600 whitespace-nowrap hover:text-gray-900">Become a Tutor</Link></li>
                        <li class="mb-6"><Link to=''  class=" text-gray-600 whitespace-nowrap hover:text-gray-900">FAQs</Link></li>
                        <li class="mb-6"><Link to=''  class=" text-gray-600 whitespace-nowrap hover:text-gray-900">Teachers</Link></li>
                        <li class="mb-6"><Link to=''  class=" text-gray-600 whitespace-nowrap hover:text-gray-900">Course</Link></li>
                    </ul>
                </div>
              
                <div class="lg:mx-auto text-left ">
                    <h4 class="text-lg text-gray-900 font-medium mb-7">Popular Requests</h4>
                    <ul class="text-sm  transition-all duration-500">
                        <li class="mb-6"><Link to=''  class="text-gray-600 hover:text-gray-900">Math Tutor</Link></li>
                        <li class="mb-6"><Link to=''  class=" text-gray-600 hover:text-gray-900">Physic Tutor</Link></li>
                        <li class="mb-6"><Link to=''  class=" text-gray-600 hover:text-gray-900">English Tutor</Link></li>
                        <li class="mb-6"><Link to=''  class=" text-gray-600 hover:text-gray-900">Computer Tutor</Link></li>
                        <li class="mb-6"><Link to=''  class=" text-gray-600 hover:text-gray-900">Biology Tutor</Link></li>
                    </ul>
                </div>
                ...
                <div class="lg:mx-auto text-left ">
                    ...
                    <ul class="text-sm  transition-all duration-500">
                        <li class="mb-6"><Link to=''  class="text-gray-600 whitespace-nowrap hover:text-gray-900">Customer Support</Link></li>
                        <li class="mb-6"><Link to=''  class=" text-gray-600 whitespace-nowrap hover:text-gray-900">Cookies</Link></li>
                        <li class="mb-6"><Link to=''  class=" text-gray-600 whitespace-nowrap hover:text-gray-900">License</Link></li>
            ...
            <div class="py-7 border-t border-gray-200">
                <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                    ...
                    <div class="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                        ...
                        <Link to=''  class="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[linear-gradient(45deg,#FEE411_6.9%,#FEDB16_10.98%,#FEC125_17.77%,#FE983D_26.42%,#FE5F5E_36.5%,#FE2181_46.24%,#9000DC_85.57%)]  hover:bg-gradient-to-b from-gray-900 to-gray-900  
                        ">
                        ...
                        <Link to=''  class="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#337FFF]  hover:bg-gray-900 ">
                        ...
                        <Link to='' class="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#FF0000]  hover:bg-gray-900 ">
