...
export default function Header() {
  ...
  return (
    <div className=" shadow-sm shadow-slate-400">
      <nav
        aria-label="Global"
      ...
      >
        ...
        <Menu as="div">
          ...
          <MenuItems className="absolute right-8 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black/5 focus:outline-none">
            <MenuItem>
              <button
