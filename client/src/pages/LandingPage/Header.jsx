    ...
    <div className="bg-rose-50">
      <nav aria-label="Global" className="w-full flex items-center justify-between p-6 lg:px-8">
        ...
        <div className=" lg:flex lg:flex-1 lg:justify-end gap-x-5">
          ...
          <Link to="/howWork" className="text-sm font-semibold text-gray-900">
            How its works
          </Link>
          <Link to="/price" className="text-sm font-semibold text-gray-900">
            Prices
          </Link>
          <Link to="/becomeTutor" className="text-sm font-semibold text-gray-900">
            Become a tutor
          </Link>
        </PopoverGroup>
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              ...
              <div className="py-6 flex justify-between">
               ...
               <Link
                  to="/logins"
                  className="-mx-3  rounded-lg px-3 py-2 text-base/7 font-semibold  hover:bg-gray-50"
                >
                Login
                </Link>
               </button>
