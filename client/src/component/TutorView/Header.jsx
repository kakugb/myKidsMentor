    ...
    <div className="bg-white shadow-sm shadow-slate-400">
      <nav aria-label="Global" className="w-full flex items-center justify-between p-2 lg:px-4">
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-8 ">
          <Link to="/tutor/dashboard" className="text-md font-semibold text-teal-700 hover:text-teal-900">
            Tutor Profile
          </Link>
          <Link to="/tutor/documents" className="text-md font-semibold text-teal-700 hover:text-teal-900">
            Add Documents
          </Link>
          <Link to="/tutor/messages" className="text-md font-semibold text-teal-700 hover:text-teal-900">
            Messages
          </Link>
          <Link to="/tutor/reviews" className="text-md font-semibold text-teal-700 hover:text-teal-900">
            Reviews & Rating
          </Link>
